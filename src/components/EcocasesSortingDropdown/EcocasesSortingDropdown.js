...
const i18n = defineMessages({
  newest: {
    id: 'comp.ecocasesSortingDropdown.newest',
    defaultMessage: 'Newest'
  },
  upvotes: {
    id: 'comp.ecocasesSortingDropdown.upvotes',
    defaultMessage: 'Upvotes'
  },
  comments: {
    id: 'comp.ecocasesSortingDropdown.comments',
...
@injectIntl
@Radium
export default class EcocasesSortingDropdown extends Component {
  static propTypes = {
